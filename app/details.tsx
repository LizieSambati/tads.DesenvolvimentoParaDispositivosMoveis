...
import { TouchableOpacity, StyleSheet, Text, View, ImageBackground, SafeAreaView, Image } from "react-native";
...
const Details = () => {
    ...
    const { id } = route.params as RouteParams;  // Obter o id da rota

    const { hunger, sleep, hygiene, fun, eat, clean, medicine, light, setLight } = useAttributes(id);
